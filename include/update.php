 ...
 * @version        $Id: 1.0 update.php 14050 Sat 2016-05-07 14:44:00Z Timgno $
 */
/**
 * @param      $module
 ...
 * @return bool|null
 */
function xoops_module_update_video(&$module, $prev_version = null)
{
    // irmtfan bug fix: solve templates duplicate issue
    $ret = null;
    if ($prev_version < 10) {
        $ret = update_video_v10($module);
    }
 ...
 * @return bool
 */
function update_video_v10(&$module)
{
    global $xoopsDB;
